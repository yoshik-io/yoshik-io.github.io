...
{
    id: "GUN's",
    title: "Закон об оружии",
    text: `     
        <b>Гражданам разрешено открыто носить только следующее оружие:</b><br>
        Пистолеты - Pistol, Pistol50 - в целях самообороны<br>
        <i>Примечание: в случае визуального обнаружения у гражданина оружия в специальной подвеске (кобуре), сотрудник силовой структуры вправе потребовать у гражданина документы (лицензию на оружие и медицинскую карту), подтверждающие его право на владение данным оружием.</i><br><br>
        
        <b>Гражданам разрешено использовать, хранить только следующее оружие: </b><br>
        Пистолеты - Pistol, Pistol50 - в целях самообороны<br>
        Дробовики - Bullpup Shotgun, Pump Shotgun,SawnOff Shotgun, Double Barrel Shotgun, Pump Shotgun Mk2 - в целях профессиональной охоты, в зонах предназначенных для охоты, запрещено использовать в населенных пунктах<br>
        Пистолеты пулеметы - Compat PDW - в целях самообороны, и защиты личной собственности<br>
